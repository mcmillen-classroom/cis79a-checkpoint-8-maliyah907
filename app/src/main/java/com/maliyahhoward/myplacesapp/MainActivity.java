package com.maliyahhoward.myplacesapp;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myPlaces.add(new Place("Berkeley High School","In downtown Berkeley"));
        myPlaces.add(new Place("Home","Where I live!"));
    ...
    private void launchCreateActivtiy()
    {
